      ...
      <div class="grid grid-cols-4 gap-3">
        ...
        >
          <div class="overflow-hidden rounded-lg relative">
            <img
              :src="'http://localhost:8080/img/' + movie.image"
    ...
    const movies = ref([
      {
        ...
        genre: "Actions / Sci Fi",
        image: "Avengers_Endgame_poster.jpg",
      },
      {
        title: "The Avengers",
        genre: "Actions / Sci Fi",
        image: "TheAvengers2012Poster.jpg",
      },
      {
        title: "Captain Marvel",
        genre: "Actions / Sci Fi",
        image: "250px-CaptainMarvelPoster2019.jpg",
      },
      {
        title: "Ant Man",
        genre: "Actions / Sci Fi",
        image: "220px-Ant-Man_poster.jpg",
      },
    ]);
