<template>
  <div class="rounded-xl border-black bg-indigo-50 py-8 px-5 h-full">
    ...
    <div class=" mt-10 grid grid-cols-6 gap-x-5">
      <BestMovies />
      <div class="bg-white p-5 col-span-2 rounded-2xl">nanan</div>
    </div>
  </div>
</template>
